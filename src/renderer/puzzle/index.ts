...
export { GameType, GameTypes, GamePlayMode, RotationType as PieceRotationType } from '../../shared/puzzle/GameType';
export type { DifficultyType, ScoreType } from '../../shared/puzzle/GameType';
