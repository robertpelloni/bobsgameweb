...
export const GameTypes = {
    ...
    SPRINT: new GameType(),
    ULTRA: new GameType(),
    TIME_ATTACK: new GameType(),
    VERSUS: new GameType(),
    MARATHON: new GameType(),
    PUZZLE: new GameType(),
    SURVIVAL: new GameType(),
};

GameTypes.CLASSIC.name = "Classic";
GameTypes.MODERN.name = "Modern";

GameTypes.SPRINT.name = "Sprint";
GameTypes.SPRINT.gameMode = GamePlayMode.DROP;
GameTypes.SPRINT.scoreType = ScoreType.LINES_CLEARED;
GameTypes.SPRINT.gridHeight = 20;

GameTypes.ULTRA.name = "Ultra";
GameTypes.ULTRA.gameMode = GamePlayMode.DROP;
GameTypes.ULTRA.scoreType = ScoreType.SCORE;
GameTypes.ULTRA.gridHeight = 20;

GameTypes.TIME_ATTACK.name = "Time Attack";
GameTypes.TIME_ATTACK.gameMode = GamePlayMode.DROP;
GameTypes.TIME_ATTACK.scoreType = ScoreType.LINES_CLEARED;

GameTypes.VERSUS.name = "Versus";
GameTypes.VERSUS.gameMode = GamePlayMode.DROP;
GameTypes.VERSUS.scoreType = ScoreType.LINES_CLEARED;
GameTypes.VERSUS.playingFieldGarbageSpawnRule = GarbageSpawnRule.NONE;

GameTypes.MARATHON.name = "Marathon";
GameTypes.MARATHON.gameMode = GamePlayMode.DROP;
GameTypes.MARATHON.scoreType = ScoreType.SCORE;
GameTypes.MARATHON.gridHeight = 20;

GameTypes.PUZZLE.name = "Puzzle";
GameTypes.PUZZLE.gameMode = GamePlayMode.DROP;
GameTypes.PUZZLE.scoreType = ScoreType.LINES_CLEARED;

GameTypes.SURVIVAL.name = "Survival";
GameTypes.SURVIVAL.gameMode = GamePlayMode.DROP;
GameTypes.SURVIVAL.scoreType = ScoreType.LINES_CLEARED;
GameTypes.SURVIVAL.playingFieldGarbageSpawnRule = GarbageSpawnRule.RANDOM;
